...
{"message": "הודעה אישית", "flowers": [{"name": "שם מדויק מהמלאי", "quantity": מספר, "color": "צבע"}]}`;
      ...
      prompt = `אתה עורך זר פרחים קיים. בצע את השינוי שהלקוח ביקש והחזר את כל הזר המלא המעודכן.
...
4. אם הלקוח מבקש להוסיף פרח — הוסף אותו לרשימת flowers בנוסף לפרחים הקיימים
5. אם הלקוח מבקש להוריד פרח — הסר אותו מהרשימה
