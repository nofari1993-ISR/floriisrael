...
4. אם הלקוח מבקש להוסיף פרח — הוסף אותו לרשימת flowers בנוסף לפרחים הקיימים. אל תוריד פרחים אחרים אלא אם הלקוח ביקש!
...
8. אל תחרוג מהתקציב. אם חסר תקציב — הפחת כמות מהפרח שנוסף, לא תוריד פרחים קיימים
9. בהודעה (message) — תאר את השינוי שביצעת, בלי מספרים
10. **אל תשנה פרחים שהלקוח לא ביקש לשנות!** אם הלקוח ביקש רק להוסיף חמניות, כל שאר הפרחים נשארים בדיוק כמו שהם
