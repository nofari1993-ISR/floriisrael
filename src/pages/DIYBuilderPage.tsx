...
const FILLER = new Set(["גיבסנית", "לבנדר", "עלי דפנה", "טווידה", "חרצית עטורה"]);
const ACCESSORIES = new Set(["אגרטל"]);
  ...
  // Handle checkout - navigate directly, pass generated image if available from summary
  const handleCheckout = (bouquetImageUrl?: string | null) => {
    ...
    navigate(`/checkout?shopId=${shopId}`, {
      state: {
        ...
        isDIY: true,
        bouquetImageUrl: bouquetImageUrl || null,
      },
    });
  };
