    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-10 text-center">
          תנאי שימוש עבור פלטפורמת FloristA
        </h1>
        ...
        <div className="prose-custom space-y-8 font-body text-foreground/90 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              האתר "FloristA" (להלן: "הפלטפורמה") משמש כזירה מקוונת המקשרת בין לקוחות לבין חנויות פרחים (להלן: "הספקים") באמצעות טכנולוגיית בינה מלאכותית מתקדמת לעיצוב זרים. השימוש בפלטפורמה, לרבות ביצוע הזמנות, מהווה הסכמה מלאה לתנאים המפורטים להלן.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              FloristA עושה כל מאמץ לסנכרן את המלאי הזמין אצל הספקים בזמן אמת. עם זאת, ייתכנו שינויים קלים בין התמונה לבין הזר הסופי בשל הבדלי עונתיות, זמינות הפרח הספציפי ביום ההזמנה, או יד האמן של השוזר.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              FloristA פועלת כמתווכת טכנולוגית בלבד. האחריות על איכות הפרחים, טריותם, עמידה בלוחות זמנים של משלוח וטיב השירות חלה באופן בלעדי על הספק (חנות הפרחים) שנבחרה.
            </p>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>
              כל הזכויות בעיצובים המופקים על ידי ה-AI ובתוכן האתר שייכות ל-FloristA.
            </p>
          </section>
        </div>
      </main>
